...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } // To avoid "regeneratorRuntime is not defined" error
...
function _getData() {
  _getData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var mangaID, baseUrl, resp;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          mangaID = 'f98660a1-d2e2-461c-960d-7bd13df8b76d';
          baseUrl = 'https://api.mangadex.org';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'GET',
            url: "".concat(baseUrl, "/manga/").concat(mangaID, "/feed")
          });
        case 4:
          resp = _context.sent;
          console.log(resp.data.data.map(function (chapter) {
            return chapter.id;
          }));
        case 6:
        case "end":
